...
const formContact = ({slide,setSlide}) =>{
  ...
  const removeSocial = (e) =>{
    ...
    className="bg-green-500 w-full h-full flex  transition-all duration-300 absolute top-0">
       <form className="rounded-xl p-4 flex max-w-md flex-col gap-1 absolute bg-orange-400 w-[80%]  top-[50%] left-[50%] center-translate">
      <div>
      ...
      <Button onClick={() => setOpenModal(true)} color="success" className="p-0">
