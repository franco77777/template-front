import { ProductivityData } from "@/data/mediaEntertainment";
...
export const Productivity = ({
  ...
  const filterProductivity = ProductivityData.filter((item) =>
            ...
            <details open className="group bg-[#121212]">
              <summary className="flex cursor-pointer list-none items-center justify-between bg-[#41ef90] p-2 font-medium">
                <div className="flex items-center justify-start gap-5">
                  <img
                    src="./productivity/productivity.svg"
                    alt="media"
                    width={20}
                    height={20}
                    className="h-[20px]"
                  />
                  <span className="font-mono font-medium">Productivity</span>
                </div>
